...
const LOAN_OPTIONS: LoanOption[] = [
  {
    ...
    color: "yellow",
    url: "/emprestimo-conta-luz-negativado",
    highlighted: true,
    badge: "MAIS FÁCIL",
    available: true,
  },
  {
    ...
    color: "blue",
    url: "/emprestimo-fgts-negativado",
    highlighted: true,
    available: true,
  },
  {
    ...
    color: "green",
    url: "/emprestimo-garantias-negativado",
    available: true,
  },
  {
    id: "terceiros",
    ...
    color: "purple",
    url: "/emprestimo-avalista-negativado",
    available: true,
  },
  {
    id: "online",
