...
export const metadata: Metadata = {
  ...
  keywords: "empréstimo FGTS, antecipação saque-aniversário, empréstimo digital, melhores taxas FGTS, antecipação FGTS sem comprometer renda, crédito FGTS aprovação rápida",
