          ...
          <div className="flex flex-col lg:flex-row items-start">
            ...
            >
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  <label htmlFor="nome" className="block mb-2 text-slate-800 font-medium">
                    Nome
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="telefone" className="block mb-2 text-slate-800 font-medium">
                    Telefone (WhatsApp)
                  </label>
                  <input
                    type="tel"
                ...
                <div>
                  <label htmlFor="mensagem" className="block mb-2 text-slate-800 font-medium">
                    Mensagem
                  </label>
                  <textarea
                    id="mensagem"
                ...
                <div className="flex items-start">
                  ...
                  <label htmlFor="aceito" className="ml-2 text-slate-700">
                ...
                <div>
                  <Button
                    ...
                    className={`cursor-pointer bg-orange-500 hover:bg-orange-600 text-white px-8 py-3 h-auto rounded-lg font-medium flex items-center justify-center transition-all ${isSubmitting ? 'opacity-70 pointer-events-none' : ''}`}
                  >
                    {isSubmitting ? (
                      <>
              ...
              <div className="space-y-12">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 mb-2">Respondemos a TODOS os emails.</p>
                    <a 
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 mb-2">Atendimento rápido 24 horas.</p>
                    <a 
                ...
                <div className="bg-blue-50 rounded-xl p-6 border border-blue-100">
                  <h3 className="text-lg font-bold text-blue-800 mb-3">Horário de atendimento</h3>
                  ...
                  <div className="mt-4 pt-4 border-t border-blue-100">
                    <p className="text-slate-700 text-sm">
                      Nosso tempo médio de resposta é de até 2 horas em dias úteis.
                    </p>
                  </div>
                </div>
              </div>
