...
// Componente para link ativo da navegação
const NavLink = ({ href, children, className, icon, onClick }) => {
...
export default function Navbar() {
  ...
  // Mais opções de empréstimos para menu dropdown
  const emprestimoOptions = [
    { name: "Empréstimo Pessoal", href: "/emprestimos/pessoal", description: "Crédito rápido para suas necessidades pessoais" },
    { name: "Empréstimo Consignado", href: "/emprestimos/consignado", description: "Taxas reduzidas com desconto em folha" },
    { name: "Financiamento Imobiliário", href: "/emprestimos/imobiliario", description: "Realize o sonho da casa própria" },
    { name: "Antecipação de FGTS", href: "/emprestimos/fgts", description: "Antecipe seu saque-aniversário do FGTS" },
  ];
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          {/* Navegação para desktop com menu dropdown */}
            ...
            <NavigationMenuList className="gap-1">
              ...
              <NavigationMenuItem>
                <NavigationMenuTrigger className={cn(
                  ...
                  pathname.startsWith("/emprestimos") ? "text-orange-600" : "text-gray-700"
                )}>
          ...
          {/* Botão de CTA (Simular) para desktop com efeito de hover */}
          ...
          {/* Botão do menu mobile com animação */}
          <div className="md:hidden">
            ...
            >
              <AnimatePresence mode="wait" initial={false}>
                ...
                >
                  {isOpen ? <X className="h-6 w-6 text-orange-500" /> : <Menu className="h-6 w-6" />}
                </motion.div>
              </AnimatePresence>
            </motion.button>
          </div>
          ...
          >
            ...
            >
              {[
                ...
                { href: "/emprestimos", label: "Empréstimos", icon: <DollarSign size={18} /> },
              ...
              >
                <Button 
                  ...
                  onClick={toggleMenu}
                >
                  <Link href="/simulador" className="flex items-center justify-center gap-2">
                    <Calculator size={18} />
                    <span>Simular Agora</span>
                  </Link>
                </Button>
