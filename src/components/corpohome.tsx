...
const CorpoHome: React.FC = () => {
  ...
  return (
    <main className="w-full flex flex-col items-center bg-white overflow-hidden">
      {/* Global styles para cursor pointer */}
      <style jsx global>{globalStyles}</style>
      
      {/* Seção Hero */}
      <section className="w-full px-3 sm:px-4 py-12 sm:py-16 md:py-24 flex flex-col items-center relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-6 md:gap-12 relative z-10">
          ...
          >
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.2 }}>
              <Badge className="mb-4 sm:mb-6 bg-blue-100 text-blue-700 py-1 sm:py-1.5 px-3 sm:px-4 rounded-full shadow-sm font-medium text-xs sm:text-sm whitespace-normal text-center">
                CRÉDITO FACILITADO PARA TODOS
              </Badge>
            </motion.div>
            
            <motion.h1
              className="text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight mb-4 sm:mb-6 text-gray-900 leading-tight"
            ...
            >
              <span className="font-medium">Empréstimos com parcelas na conta de luz ou usando seu FGTS</span>, sem burocracia, 100% digital e aprovação mesmo com nome negativado.
            </motion.p>

            <motion.div
              className="flex flex-wrap gap-3 sm:gap-4 mb-6 sm:mb-8 w-full justify-center sm:justify-start"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.5, duration: 0.5 }}
            >
              {/* Botão primário melhorado com responsividade */}
              <Button
                size="lg"
                className="bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white rounded-full px-4 sm:px-6 md:px-8 py-3 sm:py-4 md:py-6 text-sm sm:text-base md:text-lg shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 hover:scale-105 active:scale-95 font-semibold flex items-center gap-1 sm:gap-2 border-2 border-orange-500 w-full sm:w-auto"
              ...
              {/* Botão secundário melhorado com responsividade */}
              <Button
                variant="outline"
                size="lg"
                className="bg-white border-2 border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white rounded-full px-4 sm:px-6 md:px-8 py-3 sm:py-4 md:py-6 text-sm sm:text-base md:text-lg font-semibold transition-all duration-300 hover:scale-105 active:scale-95 shadow-md hover:shadow-lg w-full sm:w-auto"
                aria-label="Saiba como funciona o empréstimo"
              >
                <div className="bg-blue-100 rounded-full p-1 mr-1 sm:mr-2">
            ...
            <motion.div 
              className="flex items-center gap-2 sm:gap-4 text-xs sm:text-sm text-gray-500"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              ...
              <div>
                <div className="flex items-center gap-0.5 sm:gap-1">
                  <Star fill="currentColor" className="h-3 w-3 sm:h-4 sm:w-4 text-yellow-400" />
                  <Star fill="currentColor" className="h-3 w-3 sm:h-4 sm:w-4 text-yellow-400" />
                  <Star fill="currentColor" className="h-3 w-3 sm:h-4 sm:w-4 text-yellow-400" />
                  <Star fill="currentColor" className="h-3 w-3 sm:h-4 sm:w-4 text-yellow-400" />
                  <Star fill="currentColor" className="h-3 w-3 sm:h-4 sm:w-4 text-yellow-400" />
                ...
                <div className="text-xs sm:text-sm">+10 mil clientes satisfeitos</div>
              </div>
            </motion.div>
          </motion.div>
          ...
          >
            <div className="relative">
              <div className="bg-white p-1 rounded-2xl shadow-2xl overflow-hidden">
                ...
                {/* Statistics badge */}
                <div className="absolute top-2 right-2 sm:top-4 sm:right-4 bg-orange-500 text-white rounded-full px-2 sm:px-3 py-0.5 sm:py-1 text-xs sm:text-sm font-bold flex items-center shadow-lg transform hover:scale-105 transition-transform">
                  <Zap className="h-3 w-3 sm:h-4 sm:w-4 mr-0.5 sm:mr-1" />
                  <span>Aprovação em 2min</span>
                </div>
              </div>
              
              {/* Badges reformulados para flutuarem parcialmente fora da imagem - com ajustes responsivos */}
              
              {/* Social proof - redesenhado para flutuar */}
              <div className="absolute -bottom-4 -left-2 sm:-bottom-6 sm:-left-6 transform rotate-[-4deg] bg-white rounded-xl shadow-xl p-2 sm:p-4 max-w-[85%] sm:max-w-[80%]">
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className="w-8 h-8 sm:w-12 sm:h-12 rounded-full border-2 border-blue-100 bg-blue-500 flex items-center justify-center text-xs sm:text-sm font-bold text-white shadow-md">
                  ...
                  <div>
                    ...
                    <div className="font-bold text-sm sm:text-xl text-blue-600">
                      127 empréstimos aprovados
                    </div>
                  </div>
                </div>
              </div>
              
              {/* Approval badge - redesenhado para flutuar */}
              <div className="absolute -bottom-4 -right-2 sm:-bottom-6 sm:-right-6 transform rotate-[4deg] bg-green-500 text-white rounded-xl shadow-xl p-2 sm:p-4">
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className="w-8 h-8 sm:w-12 sm:h-12 rounded-full bg-white/20 flex items-center justify-center shadow-inner">
                    <CheckCircle className="h-4 w-4 sm:h-6 sm:w-6" />
                  </div>
                  <div>
                    <div className="font-bold text-sm sm:text-xl">98% de aprovação</div>
      ...
      {/* Seção "O que é a Credios" */}
      <section className="w-full px-3 sm:px-4 py-12 sm:py-16 md:py-20 bg-gradient-to-br from-blue-600 to-indigo-800 text-white relative overflow-hidden">
        {/* Background patterns */}
        <div className="absolute inset-0 z-0 opacity-10" 
          style={{ 
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="flex flex-col md:flex-row items-center gap-6 md:gap-12">
            ...
            >
              <div className="relative">
                <div className="absolute -top-4 -left-4 sm:-top-8 sm:-left-8 w-12 h-12 sm:w-20 sm:h-20 rounded-full bg-orange-500 flex items-center justify-center shadow-xl">
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 sm:p-6 md:p-8 border border-white/20">
                  <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 sm:mb-6">O que é a <span className="text-orange-400">Credios</span>?</h2>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-6 sm:mb-8">
                    <div className="bg-white/5 rounded-xl p-3 sm:p-4 backdrop-blur-sm border border-white/10">
                      <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-blue-500/30 flex items-center justify-center mb-2 sm:mb-3">
                        <Heart className="h-4 w-4 sm:h-5 sm:w-5 text-white" />
                      </div>
                      <h3 className="font-bold mb-1 sm:mb-2 text-sm sm:text-base">Nossa Missão</h3>
                    ...
                    <div className="bg-white/5 rounded-xl p-3 sm:p-4 backdrop-blur-sm border border-white/10">
                      ...
                      <h3 className="font-bold mb-1 sm:mb-2 text-sm sm:text-base">Nossa Visão</h3>
                      <p className="text-white/80 text-xs sm:text-sm">
            ...
            >
              <div className="relative z-10">
                <div className="bg-gradient-to-br from-blue-500 to-indigo-600 p-1 rounded-2xl shadow-2xl relative overflow-hidden">
                  <Image 
                    src="/comunidade-feliz.jpg" 
                ...
                {/* Stats cards - já estão com o estilo desejado */}
                <div className="absolute -bottom-4 -left-4 sm:-bottom-6 sm:-left-6 bg-white rounded-xl shadow-xl p-2 sm:p-4 transform rotate-[-3deg]">
                  <div className="flex items-center gap-2 sm:gap-3">
                    <div className="w-8 h-8 sm:w-12 sm:h-12 rounded-full bg-orange-500 flex items-center justify-center">
                      <User className="h-4 w-4 sm:h-6 sm:w-6 text-white" />
                    </div>
                    <div>
                      <div className="text-xs text-gray-500">Impacto Social</div>
                      <div className="text-sm sm:text-xl font-bold text-gray-800">+50 mil famílias</div>
                      <div className="text-xs text-gray-500">beneficiadas</div>
                    </div>
                  </div>
                </div>
                
                <div className="absolute -top-4 -right-4 sm:-top-6 sm:-right-6 bg-green-500 rounded-xl shadow-xl p-2 sm:p-4 transform rotate-[3deg]">
                  <div className="flex items-center gap-2 sm:gap-3">
                    <div className="w-8 h-8 sm:w-12 sm:h-12 rounded-full bg-white flex items-center justify-center">
                      <BarChart className="h-4 w-4 sm:h-6 sm:w-6 text-green-500" />
                    </div>
                    <div className="text-white">
                      <div className="text-xs opacity-80">Crescimento</div>
                      <div className="text-sm sm:text-xl font-bold">+200%</div>
      ...
      <section className="w-full px-3 sm:px-4 py-12 sm:py-16 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8 sm:mb-14">
            <Badge className="mb-3 sm:mb-4 bg-blue-100 text-blue-700 py-1 sm:py-1.5 px-3 sm:px-4 rounded-full font-medium text-xs sm:text-sm">
              SOLUÇÕES DE CRÉDITO
            </Badge>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3 sm:mb-4">
              Nossos Produtos
            </h2>
            <div className="h-1 w-16 sm:w-20 bg-orange-500 mx-auto mb-4 sm:mb-6 rounded-full"></div>
                ...
                <CardContent className="p-0 h-full">
                  <div className="p-8 flex flex-col h-full">
                    <div className="flex items-start justify-between mb-4 sm:mb-6">
                      ...
                      <Badge className="bg-orange-100 text-orange-700 py-1 sm:py-1.5 px-2 sm:px-3 text-xs sm:text-sm font-medium shadow-sm">POPULAR</Badge>
                    </div>
                    
                    <h3 className="text-xl sm:text-2xl font-bold mb-2 sm:mb-3 text-gray-800 group-hover:text-orange-500 transition-colors">Empréstimo na Conta de Luz</h3>
                    <p className="text-sm sm:text-base text-gray-600 mb-4 sm:mb-6">
                      Use sua conta de energia elétrica como garantia e obtenha crédito rápido, mesmo com restrições no nome.
                    </p>
                    
                    <div className="grid grid-cols-2 gap-4 mb-6">
                      <div className="bg-gray-50 p-4 rounded-lg shadow-sm group-hover:bg-orange-50 transition-colors">
                        <p className="text-sm text-gray-500 mb-1">Valor disponível</p>
                        <p className="text-xl font-bold text-orange-500">Até R$ 3.300,00</p>
                      </div>
                      <div className="bg-gray-50 p-4 rounded-lg shadow-sm group-hover:bg-orange-50 transition-colors">
                        <p className="text-sm text-gray-500 mb-1">Prazo de pagamento</p>
                        <p className="text-xl font-bold text-orange-500">12 meses</p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3 mb-8">
                      ...
                      <div className="flex items-center gap-2">
                        <CheckCircle2 className="h-5 w-5 text-green-500" />
                        <span className="text-gray-700">Aprovação em minutos</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <CheckCircle2 className="h-5 w-5 text-green-500" />
                        <span className="text-gray-700">Receba via PIX instantaneamente</span>
                      </div>
                    </div>
                    
                                          <div className="mt-auto">
                      {/* Botão melhorado com gradiente e responsividade */}
                      <Button className="w-full bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white py-3 sm:py-4 md:py-6 text-sm sm:text-base md:text-lg rounded-full shadow-lg font-medium group-hover:shadow-xl transition-all flex items-center justify-center gap-1 sm:gap-2 transform group-hover:-translate-y-1 active:scale-95">
                        Simular Empréstimo
                ...
                <CardContent className="p-0 h-full">
                  <div className="p-8 flex flex-col h-full">
                    <div className="flex items-start justify-between mb-4 sm:mb-6">
                      ...
                      <Badge className="bg-blue-100 text-blue-700 py-1 sm:py-1.5 px-2 sm:px-3 text-xs sm:text-sm font-medium shadow-sm">RECOMENDADO</Badge>
                    </div>
                    
                    <h3 className="text-xl sm:text-2xl font-bold mb-2 sm:mb-3 text-gray-800 group-hover:text-blue-500 transition-colors">Empréstimo FGTS</h3>
                    <p className="text-sm sm:text-base text-gray-600 mb-4 sm:mb-6">
                      Antecipe seu saque-aniversário do FGTS e receba o valor anualmente com as melhores taxas do mercado.
                    </p>
                    
                    <div className="grid grid-cols-2 gap-4 mb-6">
                      <div className="bg-gray-50 p-4 rounded-lg shadow-sm group-hover:bg-blue-50 transition-colors">
                        <p className="text-sm text-gray-500 mb-1">Antecipação</p>
                        <p className="text-xl font-bold text-blue-500">Até 12 anos</p>
                      </div>
                      <div className="bg-gray-50 p-4 rounded-lg shadow-sm group-hover:bg-blue-50 transition-colors">
                        <p className="text-sm text-gray-500 mb-1">Taxa mensal</p>
                        <p className="text-xl font-bold text-blue-500">A partir de 1,49%</p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3 mb-8">
                      <div className="flex items-center gap-2">
                        <CheckCircle2 className="h-5 w-5 text-green-500" />
                        <span className="text-gray-700">Aceita negativados</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <CheckCircle2 className="h-5 w-5 text-green-500" />
                        <span className="text-gray-700">Sem comprometer renda mensal</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <CheckCircle2 className="h-5 w-5 text-green-500" />
                        <span className="text-gray-700">Contratação 100% digital</span>
                      </div>
                    </div>
                    
                                          <div className="mt-auto">
                      {/* Botão melhorado com gradiente e responsividade */}
                      <Button className="w-full bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white py-3 sm:py-4 md:py-6 text-sm sm:text-base md:text-lg rounded-full shadow-lg font-medium group-hover:shadow-xl transition-all flex items-center justify-center gap-1 sm:gap-2 transform group-hover:-translate-y-1 active:scale-95">
                        Simular Empréstimo
                        <ArrowRight className="h-4 w-4 sm:h-5 sm:w-5 transition-transform group-hover:translate-x-1" />
                      </Button>
                    </div>
      ...
      {/* Benefícios */}
      <section 
        className="w-full px-3 sm:px-4 py-12 sm:py-16 md:py-20 bg-gray-50 relative overflow-hidden"
        ref={benefitsRef}
      >
        {/* Background elements */}
            ...
            >
              <Card className="h-full border-0 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group bg-gradient-to-b from-white to-blue-50">
                <CardContent className="p-6 flex flex-col h-full">
                  <div className="w-14 h-14 rounded-full bg-blue-100 flex items-center justify-center mb-5 group-hover:scale-110 transition-transform transform duration-300 shadow-md">
                    <Zap className="h-6 w-6 text-blue-600" />
                  </div>
                  <CardTitle className="text-xl mb-4 group-hover:text-blue-600 transition-colors">Atendimento 24/7</CardTitle>
                  <p className="text-gray-600 text-sm">
                    Processo 100% digital e automatizado, disponível a qualquer hora do dia ou da noite para sua conveniência.
                  </p>
                  <div className="mt-6 pt-4 border-t border-gray-100">
                    <Button variant="ghost" className="p-0 h-auto flex items-center gap-1 text-blue-600 hover:text-blue-700 transition-colors cursor-pointer">
            ...
            >
              <Card className="h-full border-0 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group bg-gradient-to-b from-white to-blue-50">
                <CardContent className="p-6 flex flex-col h-full">
                  ...
                  <CardTitle className="text-xl mb-4 group-hover:text-blue-600 transition-colors">Segurança Garantida</CardTitle>
                  <p className="text-gray-600 text-sm">
                    Suas informações estão protegidas com a mais avançada tecnologia de criptografia e protocolos de segurança.
                  </p>
                  <div className="mt-6 pt-4 border-t border-gray-100">
                    <Button variant="ghost" className="p-0 h-auto flex items-center gap-1 text-blue-600 hover:text-blue-700 transition-colors">
                      <span>Saiba mais</span>
                      <ArrowUpRight className="h-4 w-4" />
                    </Button>
                  </div>
            ...
            >
              <Card className="h-full border-0 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group bg-gradient-to-b from-white to-blue-50">
                <CardContent className="p-6 flex flex-col h-full">
                  ...
                  <CardTitle className="text-xl mb-4 group-hover:text-blue-600 transition-colors">Processo Rápido</CardTitle>
                  <p className="text-gray-600 text-sm">
            ...
            >
              <Card className="h-full border-0 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group bg-gradient-to-b from-white to-blue-50">
                <CardContent className="p-6 flex flex-col h-full">
                  ...
                  <CardTitle className="text-xl mb-4 group-hover:text-blue-600 transition-colors">Sem Burocracia</CardTitle>
                  <p className="text-gray-600 text-sm">
      ...
      {/* Depoimentos - implementado com Swiper */}
      <section 
        className="w-full px-3 sm:px-4 py-12 sm:py-16 md:py-20 bg-white relative overflow-hidden"
        ref={testimonialsRef}
      >
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <motion.div
            ...
            className="relative"
          >
            {/* Implementação do carrossel com Swiper - ajustado para mobile */}
            <Swiper
                    ...
                    <CardHeader>
                      <div className="flex justify-between items-start">
                        <div className="flex items-start gap-3">
                          <div className="w-12 h-12 rounded-full bg-gradient-to-br from-blue-400 to-indigo-500 text-white flex items-center justify-center font-bold relative overflow-hidden shadow-md">
                            {testimonial.name
                              .split(" ")
                              .map(part => part[0])
                              .join("")
            ...
            >
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-6 rounded-xl shadow-sm">
                <div className="flex flex-col items-center text-center">
                  ...
                  <div className="text-3xl font-bold text-blue-600 mb-1">10 mil+</div>
                  <div className="text-gray-600 text-sm">Clientes satisfeitos</div>
                </div>
              </div>
              
              <div className="bg-gradient-to-br from-orange-50 to-yellow-50 p-6 rounded-xl shadow-sm">
                <div className="flex flex-col items-center text-center">
                  <div className="w-14 h-14 rounded-full bg-orange-100 flex items-center justify-center mb-3 shadow-inner">
                    <Star className="h-6 w-6 text-orange-500" fill="currentColor" />
                  </div>
                  <div className="text-3xl font-bold text-orange-500 mb-1">4.8/5</div>
              ...
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-6 rounded-xl shadow-sm">
                <div className="flex flex-col items-center text-center">
                  <div className="w-14 h-14 rounded-full bg-green-100 flex items-center justify-center mb-3 shadow-inner">
                    <CheckCircle className="h-6 w-6 text-green-600" />
                  </div>
                  <div className="text-3xl font-bold text-green-600 mb-1">98%</div>
                  <div className="text-gray-600 text-sm">Taxa de aprovação</div>
                </div>
              </div>
              
              <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-6 rounded-xl shadow-sm">
                <div className="flex flex-col items-center text-center">
                  <div className="w-14 h-14 rounded-full bg-purple-100 flex items-center justify-center mb-3 shadow-inner">
                    <Zap className="h-6 w-6 text-purple-600" />
                  </div>
                  <div className="text-3xl font-bold text-purple-600 mb-1">2 min</div>
                  <div className="text-gray-600 text-sm">Tempo de aprovação</div>
                </div>
              </div>
            </motion.div>
          </motion.div>
      ...
      {/* CTA Final */}
      <section className="w-full px-3 sm:px-4 py-12 sm:py-16 md:py-20 bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 text-white relative overflow-hidden">
        {/* Padrão de fundo */}
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            <Badge className="mb-4 sm:mb-6 bg-white/20 text-white py-1 sm:py-2 px-3 sm:px-4 rounded-full backdrop-blur-sm font-medium text-xs sm:text-sm">
              TRANSFORME SUA VIDA FINANCEIRA
            </Badge>
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6">
              Pronto para obter o crédito<br className="hidden sm:block" /> que você precisa?
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-blue-100 mb-6 sm:mb-10 max-w-3xl mx-auto px-2">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="flex flex-col md:flex-row justify-center gap-4 sm:gap-6 max-w-xl mx-auto mb-8 sm:mb-12"
          >
            {/* Botão primário melhorado com responsividade */}
            <Button
              size="lg"
              className="bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white py-4 sm:py-6 md:py-8 text-sm sm:text-base md:text-xl rounded-full w-full md:w-auto shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 active:scale-95 font-bold px-4 sm:px-6 md:px-10 flex items-center justify-center gap-1 sm:gap-2 border-2 border-orange-500"
            >
            ...
            <Button
              size="lg"
              variant="outline"
              className="bg-white/10 backdrop-blur-sm border-2 border-white text-white hover:bg-white hover:text-blue-600 py-4 sm:py-6 md:py-8 text-sm sm:text-base md:text-xl rounded-full w-full md:w-auto shadow-xl hover:shadow-2xl transition-all duration-300 active:scale-95 font-bold px-4 sm:px-6 md:px-10 flex items-center justify-center gap-1 sm:gap-3"
            >
              <div className="bg-white/20 rounded-full p-0.5 sm:p-1">
                <WhatsApp className="h-4 w-4 sm:h-5 sm:w-5" />
              </div>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-white/10 backdrop-blur-sm p-6 rounded-xl border border-white/20 max-w-3xl mx-auto"
          >
            <div className="flex items-center justify-center gap-6 flex-wrap">
              <div className="flex items-center gap-2">
                ...
                <div className="text-white text-sm">
                  ...
                  <div className="font-medium">(11) 1234-5678</div>
                </div>
              </div>
          ...
          <div className="flex flex-wrap justify-center gap-2 sm:gap-4 mt-8 sm:mt-12 text-center">
            <Badge className="bg-white/10 text-white py-1 sm:py-1.5 px-2 sm:px-3 backdrop-blur-sm text-xs sm:text-sm">
